...
- `src/App.tsx` currently holds the entire page — the project has no routing or state management yet, so as it grows, expect new UI to be broken out into `src/pages/`.
